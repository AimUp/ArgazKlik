<?php	
	...
	$soapclient = new nusoap_client( 'http://localhost:1234/argazklik/PHP/Balioztapenak/checkPasahitza-SOAPserver.php?wsdl', true); //localhost
	...
	$erantzuna = $soapclient->call('egiaztatuP',array($_POST['pasahitza']));
	echo $erantzuna;
?>